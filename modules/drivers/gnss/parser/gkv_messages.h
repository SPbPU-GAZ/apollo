...
struct CustomPacket {
  float wx;                  // [21] Angular velocity (degress in second)
  float wy;                  // [22] Angular velocity (degress in second)
  float wz;                  // [23] Angular velocity (degress in second)
  float pitch;               // [36] Eulers (degrees)
  float roll;                // [37] Eulers (degrees)
  float yaw;                 // [38] Eulers (degrees)
  ...
  uint32_t gps_time_ms;      // [68] Time offset from the beginning of the week (miliseconds)
  float gps_week;            // [73] Number of the week from 05.01.1980
  float lax;                 // [49] Linear acceleration (meters per square second)
  float lay;                 // [50] Linear acceleration (meters per square second)
  float laz;                 // [51] Linear acceleration (meters per square second)
